...
ann_result1 <- predict(m1,anntrain)
...
train(AdoptionSpeed ~ ., data = test, method = "treebag",
      trControl = ctrl)
```
The mode's accuracy is `r bag_acc`, which seems to have fit the training data well. And the kappa statistic of 0.21 for this model suggests that the bagged tree model performs on par with our C5.0 decision tree.
